local M = {
	{
		...
		opts = {
			colorscheme = function()
				...
				vim.g.terminal_color_2 = colors.secondary -- green
				vim.g.terminal_color_3 = colors.warning -- yellow
				vim.g.terminal_color_4 = colors.primary -- blue
				vim.g.terminal_color_5 = colors.purple -- magenta
				vim.g.terminal_color_6 = colors.info -- cyan
				vim.g.terminal_color_7 = colors.fg -- white
				-- Terminal ANSI colors (bright)
				vim.g.terminal_color_8 = colors.muted -- bright black
				vim.g.terminal_color_9 = colors.accent -- bright red
				vim.g.terminal_color_10 = colors.secondary -- bright green
				vim.g.terminal_color_11 = colors.warning -- bright yellow
				vim.g.terminal_color_12 = colors.primary -- bright blue
